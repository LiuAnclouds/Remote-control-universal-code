...
#define 		PHYTEST_MODE_OVER_HCI_WITH_UART			3   //Direct Test Mode over HCI(UART hardware interface)
	...
	#define			CR_BACK							0xfe
	#define			CR_MENU							0xff
#if (__PROJECT_8278_FEATURE_TEST__)
	//key map
	...
	#define  		KB_DRIVE_PINS  {GPIO_PD5, GPIO_PD2, GPIO_PD4, GPIO_PD6, 0}
	#define  		KB_SCAN_PINS   {GPIO_PC5, 0, GPIO_PB2, GPIO_PA4, GPIO_PA3, GPIO_PD3}
...
#define DEBUG_GPIO_ENABLE							0
		...
		#define GPIO_CHN1							GPIO_PB6
		#define GPIO_CHN2							GPIO_PB7
		#define GPIO_CHN3							GPIO_PA2
		#define GPIO_CHN4							GPIO_PA3
		#define GPIO_CHN5							GPIO_PA4
